...
const workSamples = [
  {
    ...
    description: "Comprehensive mobile-fronting web app that streamlines, digitalizes, and centralizes project monitoring, beneficiary interaction, and event coordination for the non-profit organization CHAI Taguig. Includes live app of the project (link found in GitHub repository below).",
    image: chaiMetImg,
  ...
  },
  {
    ...
    description: "Interactive web database app that that allows students to easily book and reserve computer seats across laboratory rooms in DLSU. Includes live web demo of the project (link found in GitHub repository below).",
    image: labmateImg,
  ...
  },
  {
    ...
    description: "A mobile app prototype that helps users sort, categorize, and donate their unused items through AI-assisted inventorying and a centralized hub of verified organizations and peer-to-peer options. It streamlines the decluttering process by making donation decisions faster, clearer, and more convenient. Includes a live functional Figma prototype (see link below).",
